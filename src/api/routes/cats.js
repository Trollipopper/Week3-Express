...
router.post('/', upload.single('file'), createThumbnail, catCreateRules, (req, res, next) => {
...
router.delete('/:id', authenticateToken, (req, res, next) => { return ctrl.deleteCat(req, res, next); });
